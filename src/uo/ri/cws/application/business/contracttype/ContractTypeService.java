...
public interface ContractTypeService {
	 ...
	 *             if - arg is null - name is null or empty - the number of
	 *             compensation days is negative
	 * @throws BusinessException
	 *             if: - another type of contract with the same name already
	 *             exists
	 */
	ContractTypeBLDto addContractType(ContractTypeBLDto dto)
			throws BusinessException;
	 ...
	 * @throws BusinessException
	 *             if - the contract type does not exist, or - there are
	 *             contracts registered with the contract type
	 */
	 ...
	 * @param dto
	 * @throws IllegalArgumentException
	 *             if - arg is null - nanme is null or empty - the number of
	 *             compensation days is negative
	 * @throws BusinessException
	 *             if: - the contract type does not exist, or
	 */
	 ...
	 *             DOES NOT
	 */
	Optional<ContractTypeBLDto> findContractTypeByName(String name)
			throws BusinessException;
