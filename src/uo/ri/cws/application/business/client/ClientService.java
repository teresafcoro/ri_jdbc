...
public interface ClientService {
	 ...
	 *             if there already exists another client with the same dni
	 */
	 ...
	 * @throws BusinessException
	 *             if the client does not exist or if there are vehicles
	 ...
	 *
	 * @param client
	 *            A dto identifying the client to update by the field id, and
	 *            new data in the other fields
	 * @throws BusinessException
	 *             if the client does not exist
	 * @throws IllegalArgumentException
	 *             when the argument is null or id is null or empty
	 */
	...
	/**
	 * @param sponsorID
	 *            The id of the client who recommended the workshop to this
	 *            client
